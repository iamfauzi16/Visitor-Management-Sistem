...
const props = defineProps<{ employee: Employee; positions: string[] }>();

const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Dashboard', href: route('dashboard') },
    { title: 'Karyawan', href: route('employees.index') },
    { title: 'Edit', href: route('employees.edit', props.employee.id) },
];
            ...
            <div class="mx-auto w-full max-w-full">
                <div class="rounded-lg border bg-card shadow-sm">
                    <div class="border-b px-6 py-4">
                        ...
                        <p class="text-sm text-muted-foreground">Perbarui data karyawan.</p>
                    </div>
